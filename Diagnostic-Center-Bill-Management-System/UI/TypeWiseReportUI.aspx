    ...
    <div class="container">
            ...
            <ul class="nav nav-tabs ">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item active" href="TypeWiseReportUI.aspx">Type Wise</a>
        ...
        <div class="container">
            <form id="form1" runat="server">
                ...
                <br />
                <br />
                <asp:GridView ID="TypeWiseReportGridView" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="218px" Width="381px">
